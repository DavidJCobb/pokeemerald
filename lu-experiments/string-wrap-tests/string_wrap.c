...
//#include "gflib/window.h"
//#include "include/fonts.h"
#include "gflib/characters.h"

#include "./shimmed_resources.c"

#pragma region duplicated from vanilla text.c
struct {
   u16 tileOffset;
   u8 width;
   u8 height;
...
struct SimulatedTextPrinting {
   u8 word_width;
   u8 word_length;
   u8 current_x;  // window-relative offset, not absolute
...
u8* lu_StringWrap(u8* str) {
   ...
   u8  last_space_x    = 0;    // righthand edge of last seen space
