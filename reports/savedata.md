...
This project uses an automatically-generated savedata format wherein savedata is "bitpacked" to optimize for storage space. The vanilla savedata format consumes **96.09%** of the available space, leaving 2172 bytes to spare. The bitpacked format consumes **87.21%** of that space, while wasting **0.44%** of the remaining space due to technical limitations, thereby leaving 6857 bytes to spare.
